...
// Query: *[_type == "startup" && !defined($search) || title match $search || category match $search || author -> name match $search && defined(slug.current)] | order(_createdAt desc) {  _createdAt,  _id,   slug,  author->{    _id, name, image, bio  },  title,  views,  image,  description,  category}
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc) {  _createdAt,  _id,   slug,  title,  author->{    _id, name, image, bio  },  views,  image,  description,  category}
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == \"startup\" && !defined($search) || title match $search || category match $search || author -> name match $search && defined(slug.current)] | order(_createdAt desc) {\n  _createdAt,\n  _id, \n  slug,\n  author->{\n    _id, name, image, bio\n  },\n  title,\n  views,\n  image,\n  description,\n  category\n}": STARTUPS_QUERYResult;
